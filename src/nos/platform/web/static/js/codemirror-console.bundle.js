...
// entry.js
function createPythonEditor(container, options) {
  options = options || {};
  ...
  return {
    ...
    set value(v) {
      const doc2 = cmView.state.doc.toString();
      cmView.dispatch({ changes: { from: 0, to: doc2.length, insert: v || "" } });
    },
    get readOnly() {
      return container.getAttribute("data-readonly") === "true";
    },
    set readOnly(v) {
